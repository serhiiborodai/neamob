        ...
        <div class="services-section__grid">
            <div class="services-section__content">
                <div class="services-accordion">
                    ...
                    ?>
                    <div class="services-accordion__item<?php echo $first ? ' is-active' : ''; ?>">
    ...
    <div class="container">
        <div class="value-section__grid">
            ...
            <div class="value-section__visual">
                ...
                <div class="value-laptop">
                    <?php if ($value_image) : ?>
                        <img src="<?php echo esc_url($value_image); ?>" alt="NeaMob Dashboard">
                    <?php else : ?>
                        <div class="value-laptop--placeholder">Dashboard Preview</div>
                    <?php endif; ?>
                </div>
            </div>
        </div>
        ...
        <div class="value-reports">
            ...
            <div class="value-reports__tags">
                <?php foreach ($value_tags as $tag) : 
                    ...
                    $class = 'report-tag';
                    if ($style === 'icon') $class .= ' report-tag--icon';
                    if ($style === 'icon-alt') $class .= ' report-tag--icon-alt';
                ?>
                    <?php if ($icon_only) : ?>
...
<section class="testimonials-section">
    <div class="testimonials-section__bg"></div>
    <div class="container">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-card">
                            <div class="testimonial-card__quote">
                                <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 24H6C6 15.163 13.163 8 22 8v6c-5.523 0-10 4.477-10 10zm24 0h-6c0-8.837 7.163-16 16-16v6c-5.523 0-10 4.477-10 10z" fill="currentColor"/></svg>
                            </div>
        ...
        <div class="comparison-table-wrap">
            <table class="comparison-table">
                <thead class="comparison-table__head">
                    <tr>
                        <th></th>
                        <th class="comparison-table__highlight">
                            <div class="comparison-table__logo">
                                <div class="logo-icon">
                        ...
                        <th>Corporate Agencies</th>
                        <th>Boutique Agencies</th>
                ...
                <tbody class="comparison-table__body">
                    <tr>
                        ...
                        <td class="comparison-table__highlight-cell">
                            <span class="comparison-check comparison-check--highlight">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg>
                            </span>
                        </td>
                        <td><span class="comparison-cross"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 18L18 6M6 6l12 12"/></svg></span></td>
                        <td><span class="comparison-check"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span></td>
                        <td><span class="comparison-check"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg></span></td>
                    </tr>
                    <tr>
                        <td>Proactive approach<br>to strategy and KPI building</td>
                        <td class="comparison-table__highlight-cell">
                            <span class="comparison-check comparison-check--highlight">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg>
                            </span>
                    ...
                    <tr>
                        <td>Cross client learnings on<br>seasonality and best practices</td>
                        <td class="comparison-table__highlight-cell">
                            <span class="comparison-check comparison-check--highlight">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg>
                            </span>
                    ...
                    <tr>
                        <td>Creative capabilities, and<br>performance first approach</td>
                        <td class="comparison-table__highlight-cell">
                            <span class="comparison-check comparison-check--highlight">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M5 13l4 4L19 7"/></svg>
                            </span>
        ...
        <div class="blog-grid">
            ...
            <article class="blog-card">
                ...
                <div class="blog-card__meta">
                    <?php if ($category) : ?>
                    <a href="<?php echo get_category_link($category->term_id); ?>" class="blog-card__category">
        ...
        <div class="partner-video-block">
            <div class="partner-video-block__content">
                <div class="partner-video-block__logo">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/logos/snappper.svg" alt="Snappper">
                </div>
    ...
    <div class="container">
        <div class="faq-section__grid">
            ...
            <div class="faq-list">
                ...
                ?>
                <div class="faq-item<?php echo $first ? ' is-active' : ''; ?>">
